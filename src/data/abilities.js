export const abilities = [
    // Malenia (id: 1)
    { id: 1, characterId: 1, name: "Waterfowl Dance", type: "Skill" },
    { id: 2, characterId: 1, name: "Scarlet Aeonia", type: "Skill" },

    // Radahn (id: 5)
    { id: 3, characterId: 5, name: "Starcaller Cry", type: "Skill" },
    ...
    { id: 8, characterId: 12, name: "Bloodflame Talons", type: "Incantation" },

    // Rykard (id: 13)
    { id: 9, characterId: 13, name: "Taker's Flames", type: "Skill" },
    { id: 10, characterId: 13, name: "Rancor of the Serpent", type: "Sorcery" },

    // Maliketh (id: 17)
    { id: 11, characterId: 17, name: "Destined Death", type: "Skill" },
    { id: 12, characterId: 17, name: "Black Blade", type: "Incantation" },

    // Radagon (id: 15)
    { id: 13, characterId: 15, name: "Gold Breaker", type: "Skill" },
    ...
    // Fire Giant (id: 20)
    { id: 29, characterId: 20, name: "Burn, O Flame!", type: "Incantation" },
